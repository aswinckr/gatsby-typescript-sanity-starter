...
var _default = (0, _withValuePath.default)((0, _withDocument.default)((_temp = class ReferenceInput extends _react.default.Component {
  ...
  render() {
    ...
    }, "Warning: This reference is ", _react.default.createElement("em", null, weakIs), ", but should be", ' ', _react.default.createElement("em", null, weakShouldBe), " according to schema.", _react.default.createElement("div", null, _react.default.createElement(_default3.default, {
