...
class TabbedPane extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderHeaderViewMenu", () => {
      ...
      }, this.renderTabs(), _react.default.createElement("div", {
        className: styles.headerPaneActions
      }, isSplittable && views.length > 1 && _react.default.createElement("button", {
        type: "button",
        onClick: onSplitPane,
        title: "Split pane right"
      }, _react.default.createElement("div", {
        tabIndex: -1
      }, _react.default.createElement(_splitHorizontalIcon.default, null))), isSplittable && isClosable && _react.default.createElement("button", {
        type: "button",
        onClick: onCloseView,
        title: "Close pane"
      }, _react.default.createElement("div", {
  ...
  renderTabs() {
    ...
    }, _react.default.createElement(_tabList.default, null, views.map((view, index) => _react.default.createElement(_tab.default, {
      id: "".concat(idPrefix, "tab-").concat(view.id),
      isActive: activeView === view.id,
      key: view.id,
      label: _react.default.createElement(_react.default.Fragment, null, view.title),
  ...
  render() {
    ...
    return _react.default.createElement(_DefaultPane2.default, _extends({
      hasTabs: hasTabs,
