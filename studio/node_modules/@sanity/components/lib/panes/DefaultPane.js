...
class Pane extends _react.default.PureComponent {
  ...
  render() {
    ...
    var mainChildren = isScrollable ? _react.default.createElement(_scrollContainer.default, {
    ...
    }, renderActions ? renderActions(actions) : actions.map(this.renderAction), this.renderMenu())), this.props.renderHeaderViewMenu()), hasTabs ? _react.default.createElement(_tabPanel.default, {
      "aria-labelledby": "".concat(tabIdPrefix, "tab-").concat(viewId),
      className: styles.main,
      id: "".concat(tabIdPrefix, "tabpanel"),
      role: "tabpanel"
    }, mainChildren) : _react.default.createElement("div", {
      className: styles.main
    }, mainChildren), footer && _react.default.createElement("div", {
